...
router.post('/send-order-mail', (req, res) => {
    ...
    const emailData = {
      ...
      background-size: cover;">
        <div style="padding:20px;background:rgb(255,255,255);text-align:center;box-shadow: 0 0 5px rgba(0, 0, 0, 0.9);margin:0 auto; ">
          ...
          <br>
          <p style="font-size:larger"><strong>floor:</strong> ${floor ? floor : 0}</p>
          <br>
          <p style="font-size:larger"><strong>Apartment Number:</strong> ${apartmentNumber? apartmentNumber : 0}</p>
          <br>
